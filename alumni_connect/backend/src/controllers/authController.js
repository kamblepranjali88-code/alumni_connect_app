...
const studentRegistration = async (req, res) => {
    try {
        ...
        // 1. Check if student exists in college database
      console.log('3. Querying college_students table...');
const { data: collegeStudent, error: collegeError } = await supabase
...
console.log('5. Full collegeError:', JSON.stringify(collegeError, null, 2));
    ...
    return res.status(500).json({ 
        ...
        detail: collegeError.message  // will show in browser/postman
    });
}
        ...
        console.log('7. ✅ Match found:', collegeStudent);
...
const login = async (req, res) => {
    try {
        ...
        // Extract roll number from User ID (remove 'STU_' prefix)
        ...
        // Return user data with login_count
        res.json({
...
const changePassword = async (req, res) => {
    try {
        ...
        // Update password and increment login_count
...
const updateStudentProfile = async (req, res) => {
    try {
        ...
        console.log('Update data:', { full_name, email, branch, year, interests });
        ...
        // Add these only if they exist in your table
